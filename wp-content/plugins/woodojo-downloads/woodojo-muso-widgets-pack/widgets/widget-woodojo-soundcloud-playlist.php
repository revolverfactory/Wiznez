...
class WooDojo_Widget_SoundCloud_Playlist extends WP_Widget {
	...
	public function __construct () {
		...
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'woodojo_widget_soundcloud_playlist' );

		/* Create the widget. */
		$this->WP_Widget( 'woodojo_widget_soundcloud_playlist', __( 'SoundCloud - Playlist', 'woodojo-muso-widgets-pack' ), $widget_ops, $control_ops );	
	} // End __construct()
	...
	public function widget( $args, $instance ) {  
		...
		do_action( 'widget_woodojo_soundcloud_playlist_top' );
		
		$html .= $woodojo_muso_widgets_pack->soundcloud->generate_player( $playlist, 'playlists', array( 'width' => $width, 'height' => $height, 'type' => $player_type ) );
		
		echo $html; 
		
		// Add actions for plugins/themes to hook onto.
		do_action( 'widget_woodojo_soundcloud_playlist_bottom' );
   ...
   public function form( $instance ) {       
       ...
       /* Set up some default widget settings. */
		$defaults = array(
						'title' => __( 'SoundCloud Playlist', 'woodojo-muso-widgets-pack' ), 
						'playlist' => 0, 
						'width' => '100%', 
						'height' => 300, 
		...
		$playlists = $woodojo_muso_widgets_pack->soundcloud->get_playlists();
...
?>
       ...
       <!-- Widget Playlist: Select Input -->
		<p>
			<label for="<?php echo $this->get_field_id( 'playlist' ); ?>"><?php _e( 'Playlist:', 'woodojo-muso-widgets-pack' ); ?></label>
