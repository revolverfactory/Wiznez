...
class CI_Email {
	...
	var	$smtp_host		= "mail.charania.no";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "decate@blogsoft.net";		// SMTP Username
	var	$smtp_pass		= "spamMePlease";		// SMTP Password
