...
<div class="row-item row-item-user">
    ...
    <section>
        ...
        <div class="meta"><?php echo ($userData->age); ?> years | <?php echo ucfirst($userData->city); ?>, <?php echo $userData->country; ?></div>
        <div class="meta"><?php echo ucfirst($userData->profession); ?></div>
    </section>
