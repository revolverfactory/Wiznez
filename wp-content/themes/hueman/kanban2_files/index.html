...
<head>
    ...
    <link rel="stylesheet" href="/wp-content/themes/hueman/kanban2_files/styles/4198d9ac.main.css">

    <link rel="stylesheet" href="/wp-content/themes/hueman/kanban2_files/styles/themes/default-bright.css" id="themeStylesheet">
</head>
<body ng-app="mpk" ng-controller="ApplicationController" ui-keyup="{'ctrl-shift-72':'openHelpShortcut($event)'}">
<!--[if lt IE 7]>
<p class="browsehappy">You are using an <strong>outdated</strong> browser. Please <a href="http://browsehappy.com/">upgrade your browser</a> to improve your experience.</p>
<![endif]-->

<!--[if lt IE 9]>
<script src="/wp-content/themes/hueman/kanban2_files/bower_components/es5-shim/es5-shim.js"></script>
<script src="/wp-content/themes/hueman/kanban2_files/bower_components/json3/lib/json3.min.js"></script>
<![endif]-->
                ...
                <ul class="nav navbar-nav pull-right" id="menu" ng-controller="MenuController">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="#browseArchive" title="Open archive" ng-click="openArchive(kanban)"><i class="glyphicon glyphicon-folder-open"></i> Archives</a></li>
                            <li role="presentation" class="divider"></li>
                            <li><a href="#export" title="Export Kanban to file" ng-click="export(allKanbans, kanban.name)"><i class="glyphicon glyphicon-save"></i> Export</a></li>
                            <li role="presentation" class="divider"></li>
            ...
            <div class="column">
                ...
                <ul class="cards" ui-sortable="{connectWith: '#kanban ul.cards'}" sortable="" ng-model="column.cards" style="{{minHeightOfColumn}}">
                    <li class="card" ng-repeat="card in column.cards" style="background-color: #{{colorFor(card)}}">
                        ...
                        <a href="#archiveCard" class="pull-right" title="Archive" ng-click="archive(kanban, column, card)" ng-show="isLastColumn(column.name, kanban)"><i class="glyphicon glyphicon-folder-close"></i></a>
    ...
    <form ng-submit="switchTheme()" name="selectTheme" class="noMargin">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <img src="/wp-content/themes/hueman/kanban2_files/img/themes/{{model.selectedTheme}}.jpg" width="250" class="thumbnail" style="border: 1px solid black"/>
                </div>
            </div>
        </div>
        <div class="modal-footer">
...
<script type="text/ng-template" id="HelpModal.html">
    ...
    <div class="modal-body">
        <p><span class="version">My Personal Kanban Version: 0.6.0</span> from <a href="http://greggigon.github.io/my-personal-kanban/" target="blank">http://greggigon.github.io/my-personal-kanban/</a></p>
        <p>
...
<script src="/wp-content/themes/hueman/kanban2_files/bower_components/jquery/jquery.min.js"></script>
<script src="/wp-content/themes/hueman/kanban2_files/bower_components/angular/angular.min.js"></script>
<script src="/wp-content/themes/hueman/kanban2_files/bower_components/angular-sanitize/angular-sanitize.min.js"></script>
<script src="/wp-content/themes/hueman/kanban2_files/bower_components/angular-ui-bootstrap-bower/ui-bootstrap.min.js"></script>
<script src="/wp-content/themes/hueman/kanban2_files/bower_components/angular-ui-bootstrap-bower/ui-bootstrap-tpls.min.js"></script>
<script src="/wp-content/themes/hueman/kanban2_files/bower_components/jquery-ui/ui/minified/jquery-ui.min.js"></script>
<script src="/wp-content/themes/hueman/kanban2_files/bower_components/angular-ui-utils/ui-utils.min.js"></script>
<script src="/wp-content/themes/hueman/kanban2_files/bower_components/spinjs/spin.js"></script>
<script src="/wp-content/themes/hueman/kanban2_files/bower_components/FileSaver/FileSaver.js"></script>
<script src="/wp-content/themes/hueman/kanban2_files/scripts/5ebce75f.themes.js"></script>

<script src="/wp-content/themes/hueman/kanban2_files/scripts/c7192975.scripts.js"></script>
</body>
</html>