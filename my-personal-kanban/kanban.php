              ...
              <form ng-submit="update()" class="noMargin" name="cardDetails">
                  ...
                  <div class="modal-body">
                      <!-- rf col start -->
                        ...
                        <div style="display:inline-block;">
                        <h4>Add</h4>
                        <a class="btn btn-primary btn-large btn-block" href="#"> MEMBERS </a>
                        <a class="btn btn-primary btn-large btn-block" href="#"> LABELS </a>
                        <a class="btn btn-primary btn-large btn-block" href="#"> CHECKLISTS </a>
                        
<input type="text" class="btn btn-primary btn-large btn-block datepicker" id="datepicker" placeholder="DUE DATE" style="display:inline-block;text-align:center;" onClick="$('#datepicker').datepicker();"></input>
                        <a class="btn btn-primary btn-large btn-block" href="#"> ATTACHMENTS </a>
<hr/>
<h4>Actions</h4>
<a class="btn btn-primary btn-large btn-block" href="#"> COPY </a>
<a class="btn btn-primary btn-large btn-block" href="#"> SUBSCRIBE </a>
<a class="btn btn-primary btn-large btn-block" href="#"> ARCHIVE </a>
                            </div> 
                          <!-- rf col 2 end -->  
